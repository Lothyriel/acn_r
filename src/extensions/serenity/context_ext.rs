...
use crate::application::infra::player::AudioPlayer;
use crate::{
    application::models::dto::user::GuildInfo,
...
impl ContextExt for Context<'_> {
    ...
    async fn get_player(&self) -> Result<AudioPlayer> {
        ...
        let lavalink = self.data().lavalink_client.clone();

        Ok(AudioPlayer::new(
            guild_id, user_id, jukebox, songbird, lavalink,
        ))
    }
